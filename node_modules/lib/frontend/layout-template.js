...
const html = (admin, currentAdmin, location = '/') => {
  ...
  _react.default.createElement(_reactRedux.Provider, {
    ...
    context: context,
    location: "/"
  }, _react.default.createElement(_application.default, null)))); // const appComponent = renderToString(jsx)
  ...
  return `
    ...
    <head>
	  ...
	  <style>
	  .box__Box-sc-2cgj74-0.section__Section-sc-4f436f-0.gKJnwj.admin-bro_Section label{float: left; margin-right: 10px; font-size: 16px;}
	  .box__Box-sc-2cgj74-0.section__Section-sc-4f436f-0.gKJnwj.admin-bro_Section {float:left; width:100%; margin-bottom:20px;}
	  .box__Box-sc-2cgj74-0.section__Section-sc-4f436f-0.gKJnwj.admin-bro_Section span, .box__Box-sc-2cgj74-0.section__Section-sc-4f436f-0.gKJnwj.admin-bro_Section a {float:left; padding:0; border:0; line-height:16px;}
	  .admin-bro_Section .admin-bro_Box {float:left;width:31%; margin:0 1%;}
	  .css-1pcexqc-container {width:180px;}
